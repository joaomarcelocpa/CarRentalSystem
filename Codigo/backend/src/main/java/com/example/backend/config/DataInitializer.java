...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeAutomobiles() {
        ...
        // Carros econômicos
        createAutomobile("Toyota", "Corolla", 2023, "ABC-1234", "TOY-2023", 150.0, true, "1");
        createAutomobile("Honda", "Civic", 2023, "DEF-5678", "HON-2023", 160.0, true, "2");
        createAutomobile("Volkswagen", "Jetta", 2022, "GHI-9012", "VW-2022", 140.0, true, "3");
        createAutomobile("Hyundai", "Elantra", 2023, "JKL-3456", "HYN-2023", 145.0, true, "4");
        createAutomobile("Ford", "Focus", 2022, "MNO-7890", "FOR-2022", 135.0, false, "5");

        // Carros médios
        createAutomobile("Toyota", "Camry", 2023, "PQR-1234", "CAM-2023", 200.0, true, "6");
        createAutomobile("Honda", "Accord", 2023, "STU-5678", "ACC-2023", 210.0, true, "7");
        createAutomobile("Nissan", "Altima", 2022, "VWX-9012", "ALT-2022", 190.0, true, "8");
        createAutomobile("Chevrolet", "Malibu", 2023, "YZA-3456", "MAL-2023", 185.0, true, "9");

        // SUVs
        createAutomobile("Toyota", "RAV4", 2023, "BCD-7890", "RAV-2023", 250.0, true, "10");
        createAutomobile("Honda", "CR-V", 2023, "EFG-1234", "CRV-2023", 260.0, true, "11");
        createAutomobile("Ford", "Escape", 2022, "HIJ-5678", "ESC-2022", 240.0, true, "12");
        createAutomobile("Nissan", "Rogue", 2023, "KLM-9012", "ROG-2023", 245.0, false, "13");

        // Carros de luxo
        createAutomobile("BMW", "320i", 2023, "NOP-3456", "BMW-2023", 350.0, true, "14");
        createAutomobile("Mercedes-Benz", "C200", 2023, "QRS-7890", "MB-2023", 380.0, true, "15");
        createAutomobile("Audi", "A4", 2023, "TUV-1234", "AUD-2023", 360.0, true, "16");

        // Carros compactos
        createAutomobile("Fiat", "Argo", 2023, "WXY-5678", "ARG-2023", 120.0, true, "17");
        createAutomobile("Renault", "Logan", 2022, "ZAB-9012", "LOG-2022", 110.0, true, "18");
        createAutomobile("Peugeot", "208", 2023, "CDE-3456", "208-2023", 125.0, true, "19");
    ...
    private void createAutomobile(String brand, String model, int year, String licensePlate,
            String registration, double dailyRate, boolean available, String id) {
