// Codigo/frontend/app/credit-limits/page.tsx
"use client"
...
const CreditLimitsPage: React.FC = () => {
    ...
    const isBankAgent = user?.userType === 'agente-banco'
                    ...
                    <main className="container mx-auto px-4 py-8">
                        <div className="max-w-2xl mx-auto bg-red-500/20 backdrop-blur-md rounded-xl border border-red-500/50 p-8 text-center">
                            ...
                            <p className="text-red-200 mb-6">
                                Apenas agentes bancários podem acessar a gestão de limites de crédito.
                            </p>
                            <button
                                onClick={() => router.push('/')}
