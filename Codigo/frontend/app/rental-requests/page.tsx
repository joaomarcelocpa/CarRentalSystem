...
const RentalRequestsPage: React.FC = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      const response = await ApiService.rentalRequest.updateRequestStatus(
        requestId,
        {
          status: newStatus,
        }
      ...
      setRequests((prev) =>
        prev.map((req) => (req.id === requestId ? response : req))
      );
              ...
              {selectedRequest ? (
                <div className="space-y-6 overflow-y-auto">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                      ...
                      <div className="text-sm text-white/80 space-y-2">
                        <p>
                          ...
                          {selectedRequest.automobile.brand}{" "}
                          {selectedRequest.automobile.model}
                        </p>
                        <p>
                          <strong className="text-white">Ano:</strong>{" "}
                          {selectedRequest.automobile.year}
                        </p>
                        {selectedRequest.automobile.dailyRate && (
                          <p>
                            ...
                            {formatCurrency(
                              safeNumber(selectedRequest.automobile.dailyRate)
                            )}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                      ...
                      <div className="text-sm text-white/80 space-y-2">
                        ...
                        <p>
                          ...
                          {selectedRequest.customer.emailContact}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    ...
                    <div className="text-sm text-white/80 space-y-2">
                      <p>
                        <strong className="text-white">Início:</strong>{" "}
                        {formatDate(selectedRequest.pickupDate)}
                      </p>
                      <p>
                        <strong className="text-white">Término:</strong>{" "}
                      ...
                      {selectedRequest.totalValue && (
                        <p className="flex items-center gap-1">
                          ...
                          <span className="text-green-300 font-bold">
                            {formatCurrency(
                              safeNumber(selectedRequest.totalValue)
                            )}
                          </span>
                        </p>
                      )}
        ...
        <footer className="bg-transparent py-8">
          <div className="container mx-auto px-4 text-center">
            <p className="text-white/60">
              © 2024 RentalCarSystem. Todos os direitos reservados.
            </p>
          </div>
        </footer>
      </div>
